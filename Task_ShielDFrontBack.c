...
const static struct plan plan_len_repair[MAX_NUM_DEV] = {
        {2000, 8000, 600000}, {2000, 8000, 600000}, {2000, 8000, 600000}, {2000, 8000, 600000},
        {2000, 8000, 600000}, {2000, 8000, 600000}, {2000, 8000, 600000}, {2000, 8000, 600000}
};
...
static int sub;
static int tmp_sync;
static int result[MAX_NUM_DEV] = {RESULT_STOP, RESULT_STOP, RESULT_STOP, RESULT_STOP, RESULT_STOP, RESULT_STOP, RESULT_STOP, RESULT_STOP};
...
void t_sdfb(void) /* Task: ShielD of Front and Back */
{
        ...
        for (;;) {
                ...
                case sizeof(struct frame_can):
                        ...
                        all_stop = RESULT_STOP & result[0] & result[1] & result[2] & result[3] & result[4] & result[5] & result[6] & result[7];
                        all_zero = RESULT_ZERO & result[0] & result[1] & result[2] & result[3] & result[4] & result[5] & result[6] & result[7];
                        all_dest = RESULT_DEST & result[0] & result[1] & result[2] & result[3] & result[4] & result[5] & result[6] & result[7];
