...
const static int addr[MAX_NUM_DEV] = {J1939_ADDR_SDS0, J1939_ADDR_SDS1, J1939_ADDR_SDS2, J1939_ADDR_SDS3};
...
const static int max_pos[MAX_NUM_DEV] = {50000, 50000, 50000, 50000};
...
void t_sds(void) /* Task: ShielD of Side */
{
        ...
        for (;;) {
                ...
                case sizeof(struct main):
                        ...
                        switch (verify.type) {
                        case CMD_IDLE:
                        case CMD_ACT_SDS | CMD_MODE_AUTO | CMD_DIR_STOP:
                        case CMD_ACT_SDS | CMD_MODE_MANUAL | CMD_DIR_STOP:
                                switch (cmd.type) {
                                case CMD_IDLE:
                                case CMD_ACT_SDS | CMD_MODE_AUTO | CMD_DIR_POSI:
                                case CMD_ACT_SDS | CMD_MODE_AUTO | CMD_DIR_NEGA:
                                case CMD_ACT_SDS | CMD_MODE_AUTO | CMD_DIR_STOP:
                                case CMD_ACT_SDS | CMD_MODE_MANUAL | CMD_DIR_POSI:
                                case CMD_ACT_SDS | CMD_MODE_MANUAL | CMD_DIR_NEGA:
                                case CMD_ACT_SDS | CMD_MODE_MANUAL | CMD_DIR_STOP:
                                        verify = cmd;
                                        break;
                                default:
