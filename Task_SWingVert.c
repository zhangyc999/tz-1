...
const static int io_pos_dest[MAX_NUM_DEV] = {50000, 50000, 50000, 50000};
const static int min_pos[MAX_NUM_DEV] = {-1000, -1000, -1000, -1000};
const static int max_pos[MAX_NUM_DEV] = {52200, 52200, 52200, 52200};
        ...
        for (;;) {
                ...
                case sizeof(struct frame_can):
                        ...
                        case 0xC6:
                                ...
                                tmp_load[i] = filter_judge(&ctr_ok_load[i], &ctr_err_load[i], cur_ampr[i], ampr_load[i], max_ampr[i] + 60000, 3);
#if 0
